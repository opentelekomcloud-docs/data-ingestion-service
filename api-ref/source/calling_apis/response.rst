:original_name: dis_02_0518.html
...
A status code is a group of digits, ranging from 1xx to 5xx. It indicates the status of a request. For more information, see :ref:`Status Codes <dis_02_0022>`.
