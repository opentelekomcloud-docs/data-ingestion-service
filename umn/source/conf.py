...
otcdocs_repo_name = 'opentelekomcloud-docs/data-ingestion-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/data-ingestion-service/umn/'
otcdocs_doc_title = 'User Guide'
otcdocs_doc_type = 'umn'
otcdocs_service_category = 'big_data'
otcdocs_service_title = 'Data Ingestion Service'
otcdocs_service_type = 'dis'
...
html_title = "Data Ingestion Service - User Guide"
...
latex_documents = [
    ('index',
     'dis-umn.tex',
     u'Data Ingestion Service - User Guide',
